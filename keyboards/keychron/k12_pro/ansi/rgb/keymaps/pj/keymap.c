...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_61_ansi(
        ...
        KC_LSFT,      CTL_T(KC_Z), OPT_T(KC_X), CMD_T(KC_C), KC_V,  KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT,
        KC_LCTL,  KC_LOPTN, KC_LCMMD,                       LT(MAC_FN1, KC_SPC),                                KC_RCMMD,MO(MAC_FN1),MO(FN2), KC_RCTL),
    ...
    [MAC_FN1] = LAYOUT_61_ansi(
        ...
        _______,  BT_HST1,  BT_HST2,  BT_HST3,  _______,  _______,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT, KC_INS,   KC_PGUP,  KC_HOME,  _______, RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,  _______,  _______,  KC_UP,    KC_SNAP,  KC_PGDN,  KC_END,             _______,
        _______,            RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  NK_TOGG,  KC_LEFT,  DT_DOWN,  DT_UP,    DT_PRNT,             _______,
